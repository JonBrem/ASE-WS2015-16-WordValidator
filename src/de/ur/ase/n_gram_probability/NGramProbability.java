...
public class NGramProbability {
     ...
     */
    public static NGramProbability buildProbability(boolean fromSavedFile, String pathForDictionaries) {
        NGramProbability prob;
        if(fromSavedFile) {
            prob = new NGramProbability(3);
            prob.readFromFile(pathForDictionaries + "ngramProbability_german.txt");
        } else {
